...
const STATIC_DEMOS: Demo[] = [
  ...
  },
  {
    ...
    analysis: {
      company_summary: 'Forma Health helps employers predict and prevent workforce health deterioration before it becomes costly absenteeism.',
