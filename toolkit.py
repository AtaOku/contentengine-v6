        ...
        try:
            ...
            if tool_type == "seo":
                ...
                if not content or not keyword:
                    ...
                    return
                text, usage = call_claude(SYSTEM_SEO, prompt_seo(content, keyword, secondary), max_tokens=2000, api_key=body.get("api_key"))
                ...
                if not samples or not new_topic:
                    ...
                    return
                text, usage = call_claude(SYSTEM_VOICE, prompt_voice(samples, new_topic), max_tokens=2000, api_key=body.get("api_key"))
                ...
                if not content:
                    ...
                    return
                text, usage = call_claude(SYSTEM_SCORE, prompt_score(content, channel, goal), max_tokens=1500, api_key=body.get("api_key"))
